...
} from '@skyxexchange/v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
...
const v3CoreFactoryFixture: Fixture<{poolDeployer: Contract, factory: Contract}> = async ([wallet]) => {
...
export const v3RouterFixture: Fixture<{
  ...
  const { poolDeployer, factory } = await v3CoreFactoryFixture([wallet], provider)
  ...
  return { weth9, factoryV2, poolDeployer, factory, nft, router }
}
