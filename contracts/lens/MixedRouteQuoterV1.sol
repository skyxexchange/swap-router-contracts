...
import '@skyxexchange/v3-periphery/contracts/libraries/CallbackValidation.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, ISkyXV3SwapCallback, PeripheryImmutableState {
    ...
    function getPairAmountOut(
        ...
        (uint256 reserveIn, uint256 reserveOut) = SkyXV2Library.getReserves(factoryV2, tokenIn, tokenOut);
        return SkyXV2Library.getAmountOut(amountIn, reserveIn, reserveOut);
    }
